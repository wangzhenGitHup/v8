...
#define TORQUE_ASSIGNED_INSTANCE_TYPES(V) \
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_STRUCT_TYPE, 72) \
      ...
      V(BASELINE_DATA_TYPE, 90) \
      V(BREAK_POINT_TYPE, 91) \
      V(BREAK_POINT_INFO_TYPE, 92) \
      V(CACHED_TEMPLATE_OBJECT_TYPE, 93) \
      V(CALL_HANDLER_INFO_TYPE, 94) \
      V(CLASS_POSITIONS_TYPE, 95) \
      V(DEBUG_INFO_TYPE, 96) \
      V(ENUM_CACHE_TYPE, 97) \
      V(FEEDBACK_CELL_TYPE, 98) \
      V(FUNCTION_TEMPLATE_RARE_DATA_TYPE, 99) \
      V(INTERCEPTOR_INFO_TYPE, 100) \
      V(INTERPRETER_DATA_TYPE, 101) \
      V(MODULE_REQUEST_TYPE, 102) \
      V(PROMISE_CAPABILITY_TYPE, 103) \
      V(PROMISE_REACTION_TYPE, 104) \
      V(PROPERTY_DESCRIPTOR_OBJECT_TYPE, 105) \
      V(PROTOTYPE_INFO_TYPE, 106) \
      V(REG_EXP_BOILERPLATE_DESCRIPTION_TYPE, 107) \
      V(SCRIPT_TYPE, 108) \
      V(SOURCE_TEXT_MODULE_INFO_ENTRY_TYPE, 109) \
      V(STACK_FRAME_INFO_TYPE, 110) \
      V(TEMPLATE_OBJECT_DESCRIPTION_TYPE, 111) \
      V(TUPLE2_TYPE, 112) \
      V(WASM_EXCEPTION_TAG_TYPE, 113) \
      V(WASM_EXPORTED_FUNCTION_DATA_TYPE, 114) \
      V(WASM_INDIRECT_FUNCTION_TABLE_TYPE, 115) \
      V(WASM_JS_FUNCTION_DATA_TYPE, 116) \
    ...
    V(FIRST_FIXED_ARRAY_BASE_TYPE, 117) \
      V(FIRST_FIXED_ARRAY_TYPE, 117) \
        ...
        V(SCRIPT_CONTEXT_TABLE_TYPE, 129) \
      V(LAST_FIXED_ARRAY_TYPE, 129) \
      V(BYTE_ARRAY_TYPE, 130) \
      V(BYTECODE_ARRAY_TYPE, 131) \
      V(FIXED_DOUBLE_ARRAY_TYPE, 132) \
      V(INTERNAL_CLASS_WITH_SMI_ELEMENTS_TYPE, 133) \
      V(SLOPPY_ARGUMENTS_ELEMENTS_TYPE, 134) \
    V(LAST_FIXED_ARRAY_BASE_TYPE, 134) \
    V(FIRST_CONTEXT_TYPE, 135) \
      V(AWAIT_CONTEXT_TYPE, 135) \
      V(BLOCK_CONTEXT_TYPE, 136) \
      V(CATCH_CONTEXT_TYPE, 137) \
      V(DEBUG_EVALUATE_CONTEXT_TYPE, 138) \
      V(EVAL_CONTEXT_TYPE, 139) \
      V(FUNCTION_CONTEXT_TYPE, 140) \
      V(MODULE_CONTEXT_TYPE, 141) \
      V(NATIVE_CONTEXT_TYPE, 142) \
      V(SCRIPT_CONTEXT_TYPE, 143) \
      V(WITH_CONTEXT_TYPE, 144) \
    V(LAST_CONTEXT_TYPE, 144) \
    V(FIRST_EXPORTED_SUB_CLASS_BASE_TYPE, 145) \
      V(EXPORTED_SUB_CLASS_BASE_TYPE, 145) \
      V(EXPORTED_SUB_CLASS_TYPE, 146) \
      V(EXPORTED_SUB_CLASS2_TYPE, 147) \
    V(LAST_EXPORTED_SUB_CLASS_BASE_TYPE, 147) \
    V(FIRST_SMALL_ORDERED_HASH_TABLE_TYPE, 148) \
      V(SMALL_ORDERED_HASH_MAP_TYPE, 148) \
      V(SMALL_ORDERED_HASH_SET_TYPE, 149) \
      V(SMALL_ORDERED_NAME_DICTIONARY_TYPE, 150) \
    V(LAST_SMALL_ORDERED_HASH_TABLE_TYPE, 150) \
    V(FIRST_DESCRIPTOR_ARRAY_TYPE, 151) \
      V(DESCRIPTOR_ARRAY_TYPE, 151) \
      V(STRONG_DESCRIPTOR_ARRAY_TYPE, 152) \
    V(LAST_DESCRIPTOR_ARRAY_TYPE, 152) \
    V(FIRST_MODULE_TYPE, 153) \
      V(SOURCE_TEXT_MODULE_TYPE, 153) \
      V(SYNTHETIC_MODULE_TYPE, 154) \
    V(LAST_MODULE_TYPE, 154) \
    V(FIRST_UNCOMPILED_DATA_TYPE, 155) \
      V(UNCOMPILED_DATA_WITH_PREPARSE_DATA_TYPE, 155) \
      V(UNCOMPILED_DATA_WITHOUT_PREPARSE_DATA_TYPE, 156) \
    V(LAST_UNCOMPILED_DATA_TYPE, 156) \
    V(FIRST_WEAK_FIXED_ARRAY_TYPE, 157) \
      V(WEAK_FIXED_ARRAY_TYPE, 157) \
      V(TRANSITION_ARRAY_TYPE, 158) \
    V(LAST_WEAK_FIXED_ARRAY_TYPE, 158) \
    V(CELL_TYPE, 159) \
    V(CODE_TYPE, 160) \
    V(CODE_DATA_CONTAINER_TYPE, 161) \
    V(COVERAGE_INFO_TYPE, 162) \
    ...
    V(SCOPE_INFO_TYPE, 175) \
    V(SHARED_FUNCTION_INFO_TYPE, 176) \
    V(SMI_BOX_TYPE, 177) \
    V(SMI_PAIR_TYPE, 178) \
    V(SORT_STATE_TYPE, 179) \
    V(SWISS_NAME_DICTIONARY_TYPE, 180) \
    V(WASM_ARRAY_TYPE, 181) \
    V(WASM_CAPI_FUNCTION_DATA_TYPE, 182) \
    V(WASM_STRUCT_TYPE, 183) \
    V(WEAK_ARRAY_LIST_TYPE, 184) \
    V(WEAK_CELL_TYPE, 185) \
    V(FIRST_JS_RECEIVER_TYPE, 186) \
      V(JS_PROXY_TYPE, 186) \
      V(FIRST_JS_OBJECT_TYPE, 187) \
        V(JS_OBJECT_TYPE, 1057) \
        V(FIRST_JS_CUSTOM_ELEMENTS_OBJECT_TYPE, 187) \
          V(FIRST_JS_SPECIAL_OBJECT_TYPE, 187) \
            V(JS_GLOBAL_OBJECT_TYPE, 187) \
            V(JS_GLOBAL_PROXY_TYPE, 188) \
            V(JS_MODULE_NAMESPACE_TYPE, 189) \
        ...
        V(WASM_EXCEPTION_OBJECT_TYPE, 1099) \
        V(WASM_GLOBAL_OBJECT_TYPE, 1100) \
        V(WASM_INSTANCE_OBJECT_TYPE, 1101) \
        V(WASM_MEMORY_OBJECT_TYPE, 1102) \
        V(WASM_MODULE_OBJECT_TYPE, 1103) \
        V(WASM_TABLE_OBJECT_TYPE, 1104) \
