...
TF_BUILTIN(GetIteratorBaseline, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).IteratorSymbolConstant();
    tmp2 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kLoadIC), parameter0, parameter1, tmp1, parameter2, tmp0);
    tmp3 = CodeStubAssembler(state_).TaggedIndexToSmi(TNode<TaggedIndex>{parameter3});
    tmp4 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kCallIteratorWithFeedback), parameter0, parameter1, tmp2, tmp3, tmp0);
