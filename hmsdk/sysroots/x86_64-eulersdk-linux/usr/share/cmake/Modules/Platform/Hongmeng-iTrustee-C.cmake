...
# Description: Hongmeng toolchain interface for iTrustee
...
set(CMAKE_HONGMENG_CLANG_C_FLAGS_WARNINGS
    " -Wall -Werror -Wextra -Wunused -Wpointer-arith -Wmissing-declarations \
      -Wmissing-format-attribute -Wsign-compare \
      -Wuninitialized")
...
set(CMAKE_C_FLAGS_DEBUG_INIT            " -fstack-protector-strong -g ${CMAKE_HONGMENG_CLANG_C_FLAGS_WARNINGS}")
set(CMAKE_C_FLAGS_MINSIZEREL_INIT       " -fstack-protector-strong -g ${CMAKE_HONGMENG_CLANG_C_FLAGS_WARNINGS}")
set(CMAKE_C_FLAGS_RELEASE_INIT          " -fstack-protector-strong -g -O2 ${CMAKE_HONGMENG_CLANG_C_FLAGS_WARNINGS}")
set(CMAKE_C_FLAGS_RELWITHDEBINFO_INIT   " -fstack-protector-strong -g -O2 ${CMAKE_HONGMENG_CLANG_C_FLAGS_WARNINGS}")
