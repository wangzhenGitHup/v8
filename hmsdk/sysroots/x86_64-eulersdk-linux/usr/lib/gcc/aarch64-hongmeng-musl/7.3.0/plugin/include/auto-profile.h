...
/* Generate source profile information for AutoFDO after the branch
   probabilities for the various branches is calculated and annotated
   by traditional FDO.  */
extern void afdo_profile_generate (tree);
extern void write_autofdo_file (void);
extern gcov_working_set_t gcov_working_sets[NUM_GCOV_WORKING_SETS];
