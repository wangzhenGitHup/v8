...
enum unspec {
  ...
  UNSPEC_FMINNM = 175,
  UNSPEC_CVT_HFHI = 176,
  UNSPEC_CVT_HFHI2 = 177,
  UNSPEC_CVT_HIHF = 178,
  UNSPEC_CVT_HIHF2 = 179,
  UNSPEC_CVT_SIHF = 180,
  UNSPEC_CVT_SIHF2 = 181,
  UNSPEC_CVT_HFSF = 182,
  UNSPEC_CVT_SFHF = 183,
  UNSPEC_CVT_V8HFV4SF = 184,
  UNSPEC_CVT_V4SFV8HF = 185,
  UNSPEC_FADD = 186,
  UNSPEC_FSUB = 187,
  UNSPEC_FMUL = 188,
  UNSPEC_DUP_V2SF = 189,
  UNSPEC_DUP_V2HF = 190,
  UNSPEC_VMOV_V2HF = 191,
  UNSPEC_CVT_V2SFV2HF = 192,
  UNSPEC_CVT_V2HFV2SF = 193,
  UNSPEC_S_V8HIV2HF = 194,
  UNSPEC_UNS_V8HIV2HF = 195,
  UNSPEC_V8HI_ASHRV2HF = 196,
  UNSPEC_V8HI_ASHRV2HF_UNS = 197,
  UNSPEC_FRSQRTE = 198,
  UNSPEC_FMAXP = 199,
  UNSPEC_FMINP = 200,
  UNSPEC_NEG_CPX = 201,
  ...
  UNSPEC_FRADDCPX = 213,
  UNSPEC_FMULCPX = 214,
  UNSPEC_FMULCPXCNJ = 215,
  UNSPEC_FSQMAGCPX = 216,
  UNSPEC_FMLACPX = 217,
  UNSPEC_FMLSCPX = 218,
  UNSPEC_FMLACPXCNJ = 219,
  UNSPEC_FMLSCPXCNJ = 220,
  UNSPEC_VSEL = 221,
  UNSPEC_FMULCPX_OP = 222,
  UNSPEC_FMULCPXCNJ_OP = 223,
  UNSPEC_FSQMAGCPX_OP = 224,
  UNSPEC_FMLACPX_OP = 225,
  UNSPEC_FMLSCPX_OP = 226,
  UNSPEC_FMLACPXCNJ_OP = 227,
  UNSPEC_FMLSCPXCNJ_OP = 228,
  UNSPEC_VSEL_OP = 229
};
