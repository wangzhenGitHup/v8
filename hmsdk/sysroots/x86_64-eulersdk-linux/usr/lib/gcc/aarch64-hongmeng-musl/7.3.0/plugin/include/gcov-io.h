...
/* checksum flag.  */
#define GCOV_FLAG_CHECKSUM ((gcov_unsigned_t)0x6373756D) /* "csum" */
...
#define GCOV_TAG_MODULE_GROUPING ((gcov_unsigned_t)0xae000000)
#define GCOV_TAG_AFDO_CHECK_SUM ((gcov_unsigned_t)0xae100000)
...
GCOV_LINKAGE void gcov_rewrite (void);
#endif
