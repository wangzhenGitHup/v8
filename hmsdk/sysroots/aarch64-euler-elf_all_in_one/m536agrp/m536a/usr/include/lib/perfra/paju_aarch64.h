...
/* aarch64 nop */
#define __paju_aarch64_asm_nop(label_succ) 	"nop"
...
#define __paju_aarch64_asm_label_keeper_data(section_name) \
	...
	"\n" __paju_str_label_keeper_name(section_name) "_stop_name: "
#define __paju_aarch64_asm_label_keeper(section_name) \
	...
	__paju_aarch64_asm_label_keeper_data(section_name) \
	"\n\t.size " __paju_str_label_keeper_name(section_name) ", .-" __paju_str_label_keeper_name(section_name) \
	"\n\t.popsection" \
	"\n\t.endif"

#define __paju_aarch64_asm_name_section(jumpid, section_name) \
	"\n1:" \
	...
	"\n\t.popsection"
#define __paju_aarch64_asm_object_section(jumpid, section_name) \
	"\n\t.pushsection " __paju_str_object_section_name(section_name) ",\"awM\",@progbits,1" \
	"\n\t.p2align 3" \
	"\n5:" \
	"\n\t.8byte 4b, 6f" \
	"\n\t.popsection"
#define __paju_aarch64_asm_label_declare(jumpid, section_name) \
	"\n\t.pushsection " __paju_str_label_section_name(section_name) ",\"awM\",@progbits,1" \
	"\n\t.previous"
#define __paju_aarch64_asm_label_section(dst) \
	"\n2:" \
...
{
	__paju_asm_goto(__paju_aarch64_asm_label_section(dst) :::: dst);
...
#define __paju_aarch64_true(jumpid, section_name) ({ \
		__paju_asm_volatile( \
			__paju_aarch64_asm_label_keeper(section_name) \
			__paju_aarch64_asm_name_section(jumpid, section_name) \
			__paju_aarch64_asm_object_section(jumpid, section_name) \
			__paju_aarch64_asm_label_declare(jumpid, section_name)); \
		__paju_asm_volatile("" ::: "memory"); \
		__paju_aarch64_value_true(); \
	})
#else
#define __paju_aarch64_true(jumpid, section_name) __PAJU_VALUE_TRUE
#endif

#define __paju_arch_true(jumpid, section_name)	__paju_aarch64_true(jumpid, section_name)
