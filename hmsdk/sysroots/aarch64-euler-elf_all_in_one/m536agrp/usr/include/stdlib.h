...
struct random_data {
	unsigned int num;	/* effect number of the state values */
	unsigned int head;	/* head index of the state array */
	unsigned int tail;	/* tail index of the state array */
	unsigned int *state;	/* state array which contains the state value */
};
