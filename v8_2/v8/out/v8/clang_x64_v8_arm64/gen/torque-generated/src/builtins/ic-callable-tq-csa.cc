...
void CollectCallFeedback_0(compiler::CodeAssemblerState* state_, TNode<Object> p_maybeTarget, TNode<Context> p_context, TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId) {
  ...
  if (block25.is_used()) {
    ...
    ca_.Branch(tmp12, &block27, std::vector<compiler::Node*>{}, &block28, std::vector<compiler::Node*>{});
  }
  ...
  if (block29.is_used()) {
    ...
    ca_.Branch(tmp18, &block31, std::vector<compiler::Node*>{}, &block32, std::vector<compiler::Node*>{});
  }
