...
TNode<JSObject> ObjectFromEntriesFastCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_iterable, compiler::CodeAssemblerLabel* label_IfSlow) {
  ...
  if (block13.is_used()) {
    ...
    ca_.Branch(tmp14, &block15, std::vector<compiler::Node*>{phi_bb13_7}, &block16, std::vector<compiler::Node*>{phi_bb13_7});
  }
  ...
  if (block16.is_used()) {
    ...
    tmp15 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kFastCreateDataProperty), p_context, tmp7, tmp11, tmp12);
...
USE(parameter1);
  ...
  if (block23.is_used()) {
    ...
    tmp23 = ca_.CallStub<Object>(Builtins::CallableFor(ca_.isolate(), Builtins::kFastCreateDataProperty), parameter0, tmp5, tmp19, tmp20);
    }
