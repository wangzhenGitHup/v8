...
TF_BUILTIN(WasmTableFill, CodeStubAssembler) {
  ...
  TNode<Uint32T> parameter2 = UncheckedParameter<Uint32T>(Descriptor::ParameterIndex<2>());
  USE(parameter2);
  TNode<Object> parameter3 = UncheckedParameter<Object>(Descriptor::ParameterIndex<3>());
  USE(parameter3);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block3(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TF_BUILTIN(WasmThrow, CodeStubAssembler) {
  ...
  USE(parameter0);
  TNode<FixedArray> parameter1 = UncheckedParameter<FixedArray>(Descriptor::ParameterIndex<1>());
  USE(parameter1);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
TF_BUILTIN(WasmAllocatePair, CodeStubAssembler) {
  ...
  TNode<Object> parameter0 = UncheckedParameter<Object>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  TNode<Object> parameter1 = UncheckedParameter<Object>(Descriptor::ParameterIndex<1>());
  USE(parameter1);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
TF_BUILTIN(WasmSubtypeCheck, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<FixedArray> parameter0 = UncheckedParameter<FixedArray>(Descriptor::ParameterIndex<0>());
  USE(parameter0);
  TNode<Map> parameter1 = UncheckedParameter<Map>(Descriptor::ParameterIndex<1>());
  USE(parameter1);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
